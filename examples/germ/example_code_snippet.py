...
class _tmp_supernet(GermSuperNet):
    ...
    def __init__(self):
        ...
        with self.begin_searchable() as ctx:
            ...
            self.block_3 = germ.SearchableConvBNBlock(ctx,
                    in_channels=channel_choice_2, out_channels=channel_choice_2, kernel_size=3,
                    groups=channel_choice_2)
            self.block_4 = ctx.SearchableConvBNBlock(in_channels=channel_choice_2, out_channels=channel_choice_4, kernel_size=3)
