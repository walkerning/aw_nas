    ...
    def __init__(self,
        ...
        for i, stride in enumerate(self.strides):
            ...
            cur_channels = germ.Choices(mult_ratio_choices, epoch_callback=width_choices_cb,
                    post_mul_fn=divisor_fn) * self.channels[i + 1]
...
class ShuffleV2SuperNet(germ.GermSuperNet):
    ...
    def get_feature_channel_num(self, p_levels):
        ...
        return [ make_divisible(max(self.backbone.mult_ratio_choices) * self.backbone.channels[1 +
            level_indexes[p]], 2) for p in p_levels]
