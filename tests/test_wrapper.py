...
def test_wrapper_ss(tmp_path):
    ...
    ss = get_search_space("wrapper", backbone_search_space_type="cnn",
...
def test_wrapper_supernet_classification(case):
    ...
    wm = WrapperWeightsManager(ss, device, rollout_type="wrapper",
                               backbone_type=backbone_type, backbone_cfg={},
                               neck_type=None, neck_cfg={},
    ...
    wm_backbone = WrapperWeightsManager(
        ss.backbone, device, rollout_type=case,
        backbone_type=backbone_type, backbone_cfg={},
        neck_type=None, neck_cfg={},
        head_type="classification",
        head_cfg={"num_classes": 10},
